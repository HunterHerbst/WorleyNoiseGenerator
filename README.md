...
900^2 pixels of Worley noise, with 10 cells, and a distance metric of Euclidean:

![Worley Noise 900 squared pixels png](worley.png)
*Worley Noise PNG*

![Worley Noise 900 squared pixels bitmap](worley.bmp)
*Worley Noise BMP*
